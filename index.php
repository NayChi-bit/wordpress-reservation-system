  ...
  <body class="index">
    ...
    <div class="hero">
      ...
      <div class="container text-center">
        ...
        <p data-aos="zoom-in" data-aos-delay="600" class="mt-5"><a href="#" class="btn_01"><i
              class="fa-solid fa-calendar-days calendar"></i>&nbsp;BOOKING CARENDAR</a></p>
      </div>
    </div><!-- hero END -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-lg-4 cta-button">
              <p><a href="#" class="btn_01"><i class="fa-solid fa-calendar-days calendar"></i>&nbsp;BOOKING CARENDAR</a>
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="infomation">
      <div class="container background-color-block">
        ...
        <div class="text-center" data-aos="zoom-in" data-aos-delay="200">
          <p class="mt-5"><a href="<?php echo get_permalink(get_page_by_path('information')) ?>" class="btn_02">INFORMATION一覧へ</a></p>
        </div>
        ...
        <div class="row align-items-xl-center gy-5">
          ...
          <div class="col-xl-5">
            ...
            <div class="about-inner">
              ...
              <div class="text-area">
                <p>
                  個々のニーズに合わせたカスタマイズされたトレーニングプランを提供、お客様のライフスタイルや体力レベルに合わせて、効果的なトレーニングを実施し、健康的な身体作りをサポートします。また詳細なトレーナーのプロフィールや経歴などもこちらからご確認ください。
                </p>
              </div>
              <p class="mt-5 text-center text-md-start"><a href="<?php echo get_permalink(get_page_by_path('about')) ?>" class="btn_02">EASYWORKER FITの詳細へ</a></p>
            </div>
          </div>
      ...
      <div class="container background-color-block">
        ...
        <div class="container">
          <div class="row gy-4">
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="100">
              <div class="service-item d-md-flex d-block">
                <div class="icon flex-shrink-0"><img src="<?php bloginfo('template_url'); ?>/images/5.jpg"
                    class="img-fluid" /></div>
                <div>
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="200">
              <div class="service-item d-md-flex d-block">
                <div class="icon flex-shrink-0"><img src="<?php bloginfo('template_url'); ?>/images/7.jpg"
                    class="img-fluid" /></div>
                <div>
                  <div class="headline-section">
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
              <div class="service-item d-md-flex d-block">
                <div class="icon flex-shrink-0"><img src="<?php bloginfo('template_url'); ?>/images/9.jpg"
                    class="img-fluid" /></div>
                <div>
                  <div class="headline-section">
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="400">
              <div class="service-item d-md-flex d-block">
                <div class="icon flex-shrink-0"><img src="<?php bloginfo('template_url'); ?>/images/8.jpg"
                    class="img-fluid" /></div>
                <div>
                  <div class="headline-section">
                  ...
                  <p class="description">
                    ウォーキング、筋トレ、ストレッチなど、無理なく続けられる運動を取り入れ、心身ともに健康な生活を実現。体力向上、ストレス解消、体型維持など、様々な効果が期待できます。</p>
                </div>
              </div>
            </div><!-- End Service Item -->
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="500">
              <div class="service-item d-md-flex d-block">
                <div class="icon flex-shrink-0"><img src="<?php bloginfo('template_url'); ?>/images/10.jpg"
                    class="img-fluid" /></div>
                <div>
                  <div class="headline-section">
                  ...
                  <p class="description">年齢に合わせた運動で、体力向上、筋力アップ、転倒予防など、様々な効果が期待できます。無料体験やカウンセリングも実施しているので、お気軽にお問い合わせください。
                  </p>
                </div>
              </div>
            </div><!-- End Service Item -->
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="600">
              <div class="service-item d-md-flex d-block">
                <div class="icon flex-shrink-0"><img src="<?php bloginfo('template_url'); ?>/images/11.jpg"
                    class="img-fluid" /></div>
                <div>
                  <div class="headline-section">
          ...
          <div class="text-center" data-aos="zoom-in" data-aos-delay="600">
            <p class="mt-5"><a href="<?php echo get_permalink(get_page_by_path('services')) ?>" class="btn_02">SERVICEの詳細へ</a></p>
          </div>
        </div>
        ...
        <div class="row align-items-xl-center gy-5">
          ...
          <div class="col-xl-5">
            ...
            <div class="preice-inner">
              ...
              <p class="mt-5 text-center text-md-start"><a href="<?php echo get_permalink(get_page_by_path('price')) ?>" class="btn_02">PRICE LISTの詳細へ</a></p>
            </div>
          </div>
            ...
            <div class="row gy-4 icon-boxes">
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box first-time h-100">
                  <div class="icon-item mb-2">
                    <i class="fa-solid fa-user person01"></i>
                    <p>初回体験コース</p>
                  </div>
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="icon-box h-100">
                  <div class="icon-item mb-2">
                    <i class="fa-solid fa-user person02"></i>
                    <p>回数券6回コース</p>
                  </div>
    ...
    <section class="faq">
      <div class="container background-color-block">
        ...
        <div class="text-center" data-aos="zoom-in" data-aos-delay="200">
          <p class="mt-5"><a href="<?php echo get_permalink(get_page_by_path('faq')) ?>" class="btn_02">FAQの一覧へ</a></p>
        </div>
      </div>
    </section><!-- FAQ END -->
