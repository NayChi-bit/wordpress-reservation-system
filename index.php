			...
			<div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
				<div class="member d-md-flex">
					...
					<div class="member-info">
						...
						<p class="mb-4"><a href="<?php echo get_permalink(get_page_by_path('staff')->ID); ?>#tanaka-taro">ジムスタッフの詳細へ<i class="fa-solid fa-arrow-right ms-2"></i></a></p>
						<div class="social">
			...
			<div class="col-lg-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="200">
				<div class="member d-md-flex d-block">
					...
					<div class="member-info">
						...
						<p class="mb-4"><a href="<?php echo get_permalink(get_page_by_path('staff')->ID); ?>#sato-kenta">ジムスタッフの詳細へ<i class="fa-solid fa-arrow-right ms-2"></i></a></p>
						<div class="social">
							<a href="#"><i class="fa-brands fa-x-twitter"></i></a>
							<a href="#"><i class="fa-brands fa-facebook-f"></i></a>
							<a href="#"><i class="fa-brands fa-instagram"></i></a>
			...
			<div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="300">
				<div class="member d-md-flex d-block">
					...
					<div class="member-info">
						...
						<p class="mb-4"><a href="<?php echo get_permalink(get_page_by_path('staff')->ID); ?>#takahashi-misaki">ジムスタッフの詳細へ<i class="fa-solid fa-arrow-right ms-2"></i></a></p>
						<div class="social">
							<a href="#"><i class="fa-brands fa-x-twitter"></i></a>
							<a href="#"><i class="fa-brands fa-facebook-f"></i></a>
							<a href="#"><i class="fa-brands fa-instagram"></i></a>
			...
			<div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
				<div class="member d-md-flex d-block">
					...
					<div class="member-info">
						...
						<p class="mb-4"><a href="<?php echo get_permalink(get_page_by_path('staff')->ID); ?>#ito-mari">ジムスタッフの詳細へ<i class="fa-solid fa-arrow-right ms-2"></i></a></p>
						<div class="social">
							<a href="#"><i class="fa-brands fa-x-twitter"></i></a>
							<a href="#"><i class="fa-brands fa-facebook-f"></i></a>
							<a href="#"><i class="fa-brands fa-instagram"></i></a>
