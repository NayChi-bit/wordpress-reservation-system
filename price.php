...
<body class="price" data-bs-spy="scroll" data-bs-target="#navmenu">
...
<h3 class="mb-4">EASYWORKER FITの料金表</h3>
<p>お客様に合わせたトレーニングプランと、それに伴う多様な料金設定をご用意しております。</p>
</div><!-- END SECTION TITLE -->

<div class="container">

<div class="box" data-aos="fade-up" data-aos-delay="100">
<h1 class="mb-3">初期費用</h1>
<table class="tatemi02 text-center">
<tr>
<th>体験レッスン(初回限定)</th>
<td>5,000円(税込)</td>
</tr>
...
<h1 class="mb-3">初心者向けフィットネスコース</h1>
<table class="tatemi02 text-center">
<tr>
<th>回数（4回）</th>
<td>42,000円(税込)</td>
...
<h1 class="mb-3">中級者向けフィットネスコース</h1>
<table class="tatemi02 text-center">
<tr>
<th>回数（4回）</th>
<td>42,000円(税込)</td>
...
<h1 class="mb-3">上級者向けフィットネスコース</h1>
<table class="tatemi02 text-center">
<tr>
<th>回数（4回）</th>
<td>42,000円(税込)</td>
...
<h1 class="mb-3">美ボディメイクコース（女性限定） </h1>
<table class="tatemi02 text-center">
<tr>
<th>回数（4回）</th>
<td>42,000円(税込)</td>
